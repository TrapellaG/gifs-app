...
describe("SearchBar", () => {
  test("should render searhbar correctly", () => {
    const { container } = render(<SearchBar onQuery={() => {}} />);

    expect(container).toMatchSnapshot();

    //si no queremos hacer snapshot podemos verificar los componentes
  ...
  test("should call onQuery with the correct value after 700ms", async () => {
    ...
    // usar el timeout es un problema ya que si en searchBar.tsx augmentamos el tiempo de espera, la prueba se romperia
